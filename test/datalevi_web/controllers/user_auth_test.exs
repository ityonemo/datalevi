defmodule DataleviWeb.UserAuthTest do
  use DataleviWeb.ConnCase, async: true

  alias Datalevi.Accounts
  alias DataleviWeb.UserAuth
  import Datalevi.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, DataleviWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      DataleviWeb.Endpoint.subscribe(live_socket_id)
